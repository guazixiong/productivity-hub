...
public class BookmarkController {
    ...
    public ApiResponse<BookmarkImportPreviewVO> previewImport(@RequestParam("file") MultipartFile file) {
        BookmarkImportPreviewVO result = importService.previewFromExcel(file);
        return ApiResponse.ok(result);
    }
